...
export declare class GroupsService {
    ...
    getSchedules(groupId: number, userId: number, role: Role): Promise<{}[]>;
    createLesson(groupId: number, payload: CreateLessonDto, dateStr: string): Promise<{
        success: boolean;
        message: string;
        data: {
            lesson: {
    ...
    getLessonByDate(groupId: number, dateStr: string): Promise<{
        success: boolean;
        data: {
            lesson: {
                id: number;
