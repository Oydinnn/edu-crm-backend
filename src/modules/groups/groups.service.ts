...
import { GroupStatus, HomeworkStatus, Role, Status } from "@prisma/client";
...
export class GroupsService {
  ...
  async getSchedules(groupId: number, userId: number, role: Role) {
